// Blender_Recorder_Metal.cpp — Metal-specific parts of CBlender_Compile.
// Mirrors Blender_Recorder_GL.cpp, minus the GL program-pipeline (SSO) path:
// SPass::pp must stay null on Metal (see set_PP in metalR_Backend_Runtime.h) —
// vs/ps are combined into a MTL::RenderPipelineState at draw time by
// metalPipeline::GetOrCreatePSO instead.
#include "stdafx.h"
#pragma hdrstop
                              ...
                              D3DBLEND abSRC, D3DBLEND abDST, BOOL aTest, u32 aRef)
{
    ...
    // Create shaders.  Metal has no geometry shaders — the shader cache
    // (Task 16) yields a null handle for "null" GS requests.
