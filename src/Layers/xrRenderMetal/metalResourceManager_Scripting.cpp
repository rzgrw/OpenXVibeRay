// metalResourceManager_Scripting.cpp — Lua shader-script bindings for the
// Metal backend. Identical to glResourceManager_Scripting.cpp: the adopt_*
// wrappers only talk to CBlender_Compile and D3D-style enums, which the
// Metal backend maps through CommonTypes.h / metalState.
